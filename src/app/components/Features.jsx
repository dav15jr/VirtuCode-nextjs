...
export default function Features() {
  return (
    <div className="relative mt-20 sm:mt-48 border-b border-neutral-800 min-h-[600px] scroll-m-24" id="features" >
                ...
                <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
                    <div className="flex justify-center">
                        ...
                        <div className="max-w-[350px]">
                            ...
                            <p className="text-base p-2 mb-16 text-neutral-500" >{feature.description}</p>
                        </div>
                    </div>
                </div>
            ))}
